function Create(self)
	...
	self.basemass = 8.75 --weight of gun
	...
	self.ammobox = "Lee Enfield Stripper Clip"
	self.roundsperbox = 5
			...
			if self.y:IsActor() then
				...
				if self.Magazine ~= nil then
					if self.loadedShell == false then
						...
						self.loadedShell = false;
						self.Magazine.RoundCount = self.ammoCounter + 5;
					end
				else
