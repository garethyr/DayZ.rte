function Create(self)
	...
	self.recoilrisefactor = 0.065 --radians of muzzle rise to add when a shot is fired
	self.recoilriserecovery = 0.17 --radians per second of muzzle rise recovery
	...
	self.recoilsharplengthrecovery = 215 --px/s
