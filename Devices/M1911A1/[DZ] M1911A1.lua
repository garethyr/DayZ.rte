function Create(self)
	self.name = "[DZ] M1911A1"

	self.RateOfFire = 200

	self.recoilrisefactor = 0.2 --radians
	self.recoilriserecovery = 1.0 --radians per second
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.30 --radians
	self.recoilspreadrecovery = 1.0 --radians per second
	self.recoilspread = 0
	self.reloadendspread = 0.35
	
	self.recoilsharplengthfactor = 25 --px
