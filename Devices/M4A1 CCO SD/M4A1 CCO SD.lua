function Create(self)
	self.name = "M4A1 CCO SD"
	--empty name is "Empty ".. self.name

	self.recoilrisefactor = 0.070 --radians of muzzle rise to add when a shot is fired
	self.recoilriserecovery = 0.16 --radians per second of muzzle rise recovery
	...
	self.ammobox = "STANAG SD Magazine"
	self.roundsperbox = 30
end
