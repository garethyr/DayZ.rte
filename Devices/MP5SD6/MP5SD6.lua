function Create(self)
	...
	self.recoilrisefactor = 0.030 --radians
	self.recoilriserecovery = 0.35 --radians per second
	self.recoilrisemax = 1.0
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.025 --radians
	...
	self.recoilsharplengthoriginal = 150 --original aim distance
	
	self.recoiltimer = Timer()
	
	self.basemass = 5.5 --weight of gun
