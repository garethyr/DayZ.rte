function Create(self)
	...
	self.recoilrisefactor = 0.01 --radians
	self.recoilriserecovery = 0.65 --radians per second
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.05 --radians
	self.recoilspreadrecovery = 1.5 --radians per second
	self.recoilspread = 0
	self.reloadendspread = 0.35
	
	self.recoilsharplengthfactor = 20 --px
	self.recoilsharplengthrecovery = 250 --px/s
	self.recoilsharplengthoriginal = 15 --original aim distance
	...
	self.ammobox = "12 Gauge Buckshot (2)"
	self.roundsperbox = 2
