function Create(self)
	self.name = "[DZ] Makarov PM"

	self.RateOfFire = 400

	self.recoilrisefactor = 0.2 --radians
	self.recoilriserecovery = 1.1 --radians per second
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.2 --radians
	self.recoilspreadrecovery = 1.1 --radians per second
	self.recoilspread = 0
	self.reloadendspread = 0.3
	...
	self.basemass = 2 --weight of gun
	self.roundmass = 0.01 --weight of a round
	...
	self.ammobox = "Makarov PM Magazine"
	self.roundsperbox = 8
end
