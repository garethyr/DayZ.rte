function Create(self)
	self.name = "[DZ] Mk 48 Mod 0"

	self.recoilrisefactor = 0.050 --radians
	self.recoilriserecovery = 0.35 --radians per second
	self.recoilrisemax = 1.0
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.035 --radians
	self.recoilspreadrecovery = 0.1 --radians per second
	self.recoilspreadmax = 1.0
	self.recoilspread = 0
	self.reloadendspread = 0.15
	...
	self.basemass = 15 --weight of gun
	...
	self.ammobox = "M240 Belt"
	self.roundsperbox = 100
end
