function Create(self)
	self.name = "[DZ] .45 Revolver"

	self.RateOfFire = 110

	self.recoilrisefactor = .65 --radians
	self.recoilriserecovery = .58 --radians per second
	self.recoilrise = 0
	
	self.recoilspreadfactor = 0.35 --radians
	self.recoilspreadrecovery = 1.0 --radians per second
	self.recoilspread = 0
	self.reloadendspread = 0.35
	
	self.recoilsharplengthfactor = 60 --px
	...
	self.roundmass = 0.015 --weight of a round
	...
	self.ammobox = ".45 ACP Speedloader"
	self.roundsperbox = 6
end
